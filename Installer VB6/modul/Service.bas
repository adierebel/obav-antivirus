...
Public Const SERVICE_AUTO_START As Long = 2
...
Public Function GetServiceConfig(Nama As String) As Long
...
If hSCManager <> 0 Then
    hService = OpenService(hSCManager, Nama, SERVICE_QUERY_CONFIG)
    If hService <> 0 Then
        ReDim SCfg(1 To 1)
...
Public Function GetServiceStatus(Nama As String) As SERVICE_STATE
Dim hSCManager As Long, hService As Long, Status As SERVICE_STATUS
hSCManager = OpenSCManager(vbNullString, vbNullString, _
                       SC_MANAGER_CONNECT)
If hSCManager <> 0 Then
    hService = OpenService(hSCManager, Nama, SERVICE_QUERY_STATUS)
    If hService <> 0 Then
...
Public Function DeleteNTService(Nama As String) As Long
...
hSCManager = OpenSCManager(vbNullString, vbNullString, _
                       SC_MANAGER_CONNECT)
If hSCManager <> 0 Then
    hService = OpenService(hSCManager, Nama, _
                       SERVICE_ALL_ACCESS)
    If hService <> 0 Then
...
Public Function SetNTService(Nama As String, Display As String, Filename As String, Tipe As Long, StartTipe As Long, Grup As String) As Long
Dim hSCManager As Long
...
If hSCManager <> 0 Then
    hService = CreateService(hSCManager, Nama, Display, SERVICE_ALL_ACCESS, Tipe, StartTipe, SERVICE_ERROR_NORMAL, Filename, vbNullString, vbNullString, vbNullString, Grup, vbNullString)
    If hService <> 0 Then
        CloseServiceHandle hService
    Else
...
Public Function StopNTService(Nama As String) As Long
Dim hSCManager As Long, hService As Long, Status As SERVICE_STATUS
hSCManager = OpenSCManager(vbNullString, vbNullString, _
                       SC_MANAGER_CONNECT)
If hSCManager <> 0 Then
    hService = OpenService(hSCManager, Nama, SERVICE_STOP)
    If hService <> 0 Then
...
Public Function StartNTService(Nama As String) As Long
Dim hSCManager As Long, hService As Long
hSCManager = OpenSCManager(vbNullString, vbNullString, _
                       SC_MANAGER_CONNECT)
If hSCManager <> 0 Then
    hService = OpenService(hSCManager, Nama, SERVICE_START)
    If hService <> 0 Then
