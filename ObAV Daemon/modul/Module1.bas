...
Public Const Service_Name As String = "ObAV Service Loader"
Public Const Service_Display_Name As String = "ObAV Service Loader"
Public Const Service_File_Name As String = "ObAVSvc.exe -svc"
