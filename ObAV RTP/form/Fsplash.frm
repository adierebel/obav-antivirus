...
End If
'====================================================
nilanyA = GetINI("Options", "Splash", fixP(ObAVdir) & "ObAV.cfg")
If nilanyA = 1 Then
    Okokok
    Me.Visible = True
    keLiatanTuh
Else
    ...
    bsTray.ShellTrayBalloonTipShow fRtpSystem.hwnd, 1, verobAV, "Your computer protected by ObAV Guard" & vbCrLf & _
